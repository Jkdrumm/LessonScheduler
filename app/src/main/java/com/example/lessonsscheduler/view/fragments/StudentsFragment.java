 ...
 */
public class StudentsFragment extends Fragment implements InformationFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonNewStudent = (FloatingActionButton) rootView.findViewById(R.id.buttonNewStudent);
